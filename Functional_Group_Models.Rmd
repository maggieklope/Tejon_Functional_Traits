...
funct_la_plot <- plot(ggpredict(funct_la, terms = c("treatment", "climate", "functional_group")), facet = TRUE)
funct_sla_plot <- plot(ggpredict(funct_sla, terms = c("treatment", "climate", "functional_group")), facet = TRUE)
funct_ldmc_plot <- plot(ggpredict(funct_ldmc, terms = c("treatment", "climate", "functional_group")), facet = TRUE)
funct_n_plot <- plot(ggpredict(funct_n, terms = c("treatment", "climate", "functional_group")), facet = TRUE)
funct_seed_mass_plot <- plot(ggpredict(funct_seed_mass, terms = c("climate", "functional_group")), facet = TRUE)
