...
FRic_plot <- plot(ggpredict(FRic, terms = c("treatment", "climate")), facet = TRUE)
# FEve_plot <- plot(ggpredict(FEve), facet = TRUE)
FDiv_plot <- plot(ggpredict(FDiv, terms = c("treatment", "climate")), facet = TRUE)
