...
dredge(model_sla_1) # best fit is climate and species; AICc = 1155.0
model_sla_1 <- glmmTMB(data = traits, sla ~ climate + species + (1|new_block) + (1|plot), family = gaussian, na.action = na.fail)
simulateResiduals(model_sla_1, plot= T) # does not pass outlier test
...
dredge(model_sla_2) # best fit is climate only; AICc = 1159.2
model_sla_2 <- glmmTMB(data = traits, sla ~ treatment + (1|new_block) + (1|plot), family = gaussian, na.action = na.fail)
simulateResiduals(model_sla_2, plot= T) # looks good
...
dredge(model_sla_3) # best fit is climate + species; AICc = 1155.0
model_sla_3 <- glmmTMB(data = traits, sla ~ climate + species + (1|new_block) + (1|plot), family = gaussian, na.action = na.fail)
simulateResiduals(model_sla_3, plot= T) # does not pass outlier test

# SLA ~ 1 + (1|new_block/plot)
model_sla_4 <- glmmTMB(data = traits, sla ~ 1 + (1|new_block) + (1|plot), family = gaussian, na.action = na.fail)
dredge(model_sla_4) # AICc = 1381
simulateResiduals(model_sla_4, plot= T) # looks good
