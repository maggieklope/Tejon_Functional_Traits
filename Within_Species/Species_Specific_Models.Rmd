...
abund_2019 <-  read_csv("/Users/User_2/github/Tejon_Functional_Traits/Datasheets/2019_abundance_new.csv")
...
traits <- traits_2019 %>% 
  ...
  # filter(!(species == "Triteleia ixioides" | species == "Trifolium microcephalum" | species == "Symphoricarpos mollis" | species == "Ericameria nauseosa")) %>% 
...
# traits_19_avg <- traits %>% 
#   group_by(climate, treatment, new_block, species) %>% 
#   summarise_all(mean, na.rm = TRUE)
# write_csv(traits_19_avg, "/Users/User_2/github/Tejon_Functional_Traits/Datasheets/traits_19_avg.csv")
...
#### Testing with SLA: not enough data

```{r}
# NOT ENOUGH DATA
# SLA ~ treatment * species + climate * species + (1|new_block/plot)
model_sla_1 <- glmmTMB(data = traits, sla ~ treatment * species + climate * species + (1|new_block) + (1|plot), family = gaussian, na.action = na.fail)
model_sla_1a <- glmmTMB(data = traits, sla ~ treatment * species + climate * species + (1|new_block), family = gaussian, na.action = na.fail)
model_sla_1b <- glmmTMB(data = traits, sla ~ treatment * species + climate * species, family = gaussian, na.action = na.fail)
model_sla_1c <- glmmTMB(data = traits, sla ~ treatment * species + climate * species + (1|plot), family = gaussian, na.action = na.fail)
model_sla_1d <- glmmTMB(data = traits, sla ~ treatment * species * climate, family = gaussian, na.action = na.fail)
model_sla_1e <- glmmTMB(data = traits, sla ~ treatment:species + climate:species, family = gaussian, na.action = na.fail)

# SLA ~ treatment * species + (1|new_block/plot)
model_sla_2 <- glmmTMB(data = traits, sla ~ treatment * species + (1|new_block) + (1|plot), family = gaussian, na.action = na.fail)

# SLA ~ climate * species + (1|new_block/plot)
model_sla_3 <- glmmTMB(data = traits, sla ~ climate * species + (1|new_block) + (1|plot), family = gaussian, na.action = na.fail)
model_sla_3a <- glmmTMB(data = traits, sla ~ climate:species + (1|new_block) + (1|plot), family = gaussian, na.action = na.fail)

# SLA ~ 1 + (1|new_block/plot)
model_sla_4 <- glmmTMB(data = traits, sla ~ 1 + (1|new_block) + (1|plot), family = gaussian, na.action = na.fail)

# #log(SLA)
model_sla_5 <- glmmTMB(data = traits, log_sla ~ treatment * species + climate * species + (1|new_block) + (1|plot), family = gaussian, na.action = na.fail)

AICc(model_sla_1, model_sla_1a, model_sla_1b, model_sla_1c, model_sla_1d, model_sla_2, model_sla_3, model_sla_4, model_sla_5,model_sla_1e, model_sla_3a)
...
- can't do for seed mass and leaf nitrogen since I got those values from TRY, so only one value/species
...
```{r, warning = FALSE}
# interaction
bro_dia_la_1 <- glmmTMB(data = bro_dia, indiv_area ~ treatment * climate + (1|new_block), family = gaussian, na.action = na.fail)
# no interaction
bro_dia_la_2 <- glmmTMB(data = bro_dia, indiv_area ~ treatment + climate, family = gaussian, na.action = na.fail)
# climate
bro_dia_la_3 <- glmmTMB(data = bro_dia, indiv_area ~ climate + (1|new_block), family = gaussian, na.action = na.fail)
# treatment
bro_dia_la_4 <- glmmTMB(data = bro_dia, indiv_area ~ treatment, family = gaussian, na.action = na.fail)
# null
bro_dia_la_5 <- glmmTMB(data = bro_dia, indiv_area ~ 1 + (1|new_block), family = gaussian, na.action = na.fail)

AICc(bro_dia_la_1, bro_dia_la_2, bro_dia_la_3, bro_dia_la_4, bro_dia_la_5)

# best-fit intercept only
simulateResiduals(bro_dia_la_5, plot= T) # looks good
shapiro.test(residuals(bro_dia_la_5)) # normal
```
#### SLA
```{r, warning = FALSE}
# interaction
bro_dia_sla_1 <- glmmTMB(data = bro_dia, sla ~ treatment * climate + (1|new_block), family = gaussian, na.action = na.fail)
# no interaction
bro_dia_sla_2 <- glmmTMB(data = bro_dia, sla ~ treatment + climate + (1|new_block), family = gaussian, na.action = na.fail)
# climate
bro_dia_sla_3 <- glmmTMB(data = bro_dia, sla ~ climate + (1|new_block), family = gaussian, na.action = na.fail)
# treatment
bro_dia_sla_4 <- glmmTMB(data = bro_dia, sla ~ treatment + (1|new_block), family = gaussian, na.action = na.fail)
# null
bro_dia_sla_5 <- glmmTMB(data = bro_dia, sla ~ 1 + (1|new_block), family = gaussian, na.action = na.fail)

AICc(bro_dia_sla_1, bro_dia_sla_2, bro_dia_sla_3, bro_dia_sla_4, bro_dia_sla_5)

# best-fit intercept only
simulateResiduals(bro_dia_sla_5, plot= T) # not good
shapiro.test(residuals(bro_dia_sla_5)) # not normal

# log transformation
# interaction
bro_dia_sla_1 <- glmmTMB(data = bro_dia, log_sla ~ treatment * climate + (1|new_block), family = gaussian, na.action = na.fail)
# no interaction
bro_dia_sla_2 <- glmmTMB(data = bro_dia, log_sla ~ treatment + climate + (1|new_block), family = gaussian, na.action = na.fail)
# climate
bro_dia_sla_3 <- glmmTMB(data = bro_dia, log_sla ~ climate + (1|new_block), family = gaussian, na.action = na.fail)
# treatment
bro_dia_sla_4 <- glmmTMB(data = bro_dia, log_sla ~ treatment + (1|new_block), family = gaussian, na.action = na.fail)
# null
bro_dia_sla_5 <- glmmTMB(data = bro_dia, log_sla ~ 1 + (1|new_block), family = gaussian, na.action = na.fail)

AICc(bro_dia_sla_1, bro_dia_sla_2, bro_dia_sla_3, bro_dia_sla_4, bro_dia_sla_5)

# best-fit intercept only
simulateResiduals(bro_dia_sla_5, plot= T) # ok?
shapiro.test(residuals(bro_dia_sla_5)) # not normal
```
#### LDMC
```{r, warning = FALSE}
# interaction
bro_dia_ldmc_1 <- glmmTMB(data = bro_dia, ldmc ~ treatment * climate + (1|new_block), family = gaussian, na.action = na.fail)
# no interaction
bro_dia_ldmc_2 <- glmmTMB(data = bro_dia, ldmc ~ treatment + climate + (1|new_block), family = gaussian, na.action = na.fail)
# climate
bro_dia_ldmc_3 <- glmmTMB(data = bro_dia, ldmc ~ climate , family = gaussian, na.action = na.fail)
# treatment
bro_dia_ldmc_4 <- glmmTMB(data = bro_dia, ldmc ~ treatment + (1|new_block), family = gaussian, na.action = na.fail)
# null
bro_dia_ldmc_5 <- glmmTMB(data = bro_dia, ldmc ~ 1 + (1|new_block), family = gaussian, na.action = na.fail)

AICc(bro_dia_ldmc_1, bro_dia_ldmc_2, bro_dia_ldmc_3, bro_dia_ldmc_4, bro_dia_ldmc_5)

simulateResiduals(bro_dia_ldmc_5, plot= T) # ok
shapiro.test(residuals(bro_dia_ldmc_5)) # normal
```
### Festuca myuros
```{r, warning = FALSE}
fes_myu <- traits %>% 
...
```{r, warning = FALSE}
# interaction (not enough replicates)
fes_myu_la_1 <- glmmTMB(data = fes_myu, indiv_area ~ treatment * climate, family = gaussian, na.action = na.fail)
# no interaction
fes_myu_la_2 <- glmmTMB(data = fes_myu, indiv_area ~ treatment + climate+ (1|new_block), family = gaussian, na.action = na.fail)
# climate
fes_myu_la_3 <- glmmTMB(data = fes_myu, indiv_area ~ climate + (1|new_block), family = gaussian, na.action = na.fail)
# treatment
fes_myu_la_4 <- glmmTMB(data = fes_myu, indiv_area ~ treatment+ (1|new_block), family = gaussian, na.action = na.fail)
# null
fes_myu_la_5 <- glmmTMB(data = fes_myu, indiv_area ~ 1 + (1|new_block), family = gaussian, na.action = na.fail)

AICc(fes_myu_la_1, fes_myu_la_2, fes_myu_la_3, fes_myu_la_4, fes_myu_la_5)

# best-fit intercept only
simulateResiduals(fes_myu_la_3, plot= T) # not good
shapiro.test(residuals(fes_myu_la_3)) # normal

# log transformation
# interaction (not enough replicates)
fes_myu_la_1 <- glmmTMB(data = fes_myu, log_la ~ treatment * climate, family = gaussian, na.action = na.fail)
# no interaction
fes_myu_la_2 <- glmmTMB(data = fes_myu, log_la ~ treatment + climate+ (1|new_block), family = gaussian, na.action = na.fail)
# climate
fes_myu_la_3 <- glmmTMB(data = fes_myu, log_la ~ climate + (1|new_block), family = gaussian, na.action = na.fail)
# treatment
fes_myu_la_4 <- glmmTMB(data = fes_myu, log_la ~ treatment+ (1|new_block), family = gaussian, na.action = na.fail)
# null
fes_myu_la_5 <- glmmTMB(data = fes_myu, log_la ~ 1 + (1|new_block), family = gaussian, na.action = na.fail)

AICc(fes_myu_la_1, fes_myu_la_2, fes_myu_la_3, fes_myu_la_4, fes_myu_la_5)

# best-fit intercept only
simulateResiduals(fes_myu_la_3, plot= T) # good?
shapiro.test(residuals(fes_myu_la_3)) # normal
...
```{r, warning = FALSE}
# interaction (not enough replicates)
fes_myu_sla_1 <- glmmTMB(data = fes_myu, sla ~ treatment * climate, family = gaussian, na.action = na.fail)
# no interaction
fes_myu_sla_2 <- glmmTMB(data = fes_myu, sla ~ treatment + climate+ (1|new_block), family = gaussian, na.action = na.fail)
# climate
fes_myu_sla_3 <- glmmTMB(data = fes_myu, sla ~ climate + (1|new_block), family = gaussian, na.action = na.fail)
# treatment
fes_myu_sla_4 <- glmmTMB(data = fes_myu, sla ~ treatment+ (1|new_block), family = gaussian, na.action = na.fail)
# null
fes_myu_sla_5 <- glmmTMB(data = fes_myu, sla ~ 1 + (1|new_block), family = gaussian, na.action = na.fail)

AICc(fes_myu_sla_1, fes_myu_sla_2, fes_myu_sla_3, fes_myu_sla_4, fes_myu_sla_5)

# best-fit intercept only
simulateResiduals(fes_myu_sla_5, plot= T) # ok?
shapiro.test(residuals(fes_myu_sla_5)) # normal
```
#### LDMC
LDMC ~ 1 + (1|block)
```{r, warning = FALSE}
# interaction (not enough replicates)
fes_myu_ldmc_1 <- glmmTMB(data = fes_myu, ldmc ~ treatment * climate, family = gaussian, na.action = na.fail)
# no interaction
fes_myu_ldmc_2 <- glmmTMB(data = fes_myu, ldmc ~ treatment + climate+ (1|new_block), family = gaussian, na.action = na.fail)
# climate
fes_myu_ldmc_3 <- glmmTMB(data = fes_myu, ldmc ~ climate + (1|new_block), family = gaussian, na.action = na.fail)
# treatment
fes_myu_ldmc_4 <- glmmTMB(data = fes_myu, ldmc ~ treatment+ (1|new_block), family = gaussian, na.action = na.fail)
# null
fes_myu_ldmc_5 <- glmmTMB(data = fes_myu, ldmc ~ 1 + (1|new_block), family = gaussian, na.action = na.fail)

AICc(fes_myu_ldmc_1, fes_myu_ldmc_2, fes_myu_ldmc_3, fes_myu_ldmc_4, fes_myu_ldmc_5)

# best-fit intercept only
simulateResiduals(fes_myu_ldmc_5, plot= T) # ok?
shapiro.test(residuals(fes_myu_ldmc_5)) # normal
```
### Bromus hordeaceus
```{r, warning = FALSE}
bro_hor <- traits %>% 
