...
simulateResiduals(model_2, plot= T)
...
dredge(bro_dia_la) # get convergence error; best fit model is intercept only

bro_dia_la <- glm(data = bro_dia, indiv_area ~ 1 + (1|new_block), family = "gaussian", na.action = na.fail)
