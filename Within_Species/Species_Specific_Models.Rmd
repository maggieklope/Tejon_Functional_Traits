...
```{r}
traits <- traits_2019 %>% 
  filter(sla < 60) %>% # there are a few crazy outliers that I need to go double-check
  # filter(ldmc < 1000) %>%  # there are a few crazy outliers that I need to go double-check
    drop_na()
...
# SLA
model_1 <- model_1 <- glmmTMB(data = traits, sla ~ treatment * species + climate * species + (1|new_block), family = gaussian, na.action = na.fail)
dredge(model_1)
model_1 <- model_1 <- glmmTMB(data = traits, sla ~ climate + species + (1|new_block), family = gaussian, na.action = na.fail)

simulateResiduals(model_1, plot= T)
...
```{r}
# model
bro_dia_ldmc <- glmmTMB(data = bro_dia, ldmc ~ treatment * climate + (1|new_block), family = gaussian, na.action = na.fail) # convergence
bro_dia_ldmc <- glmmTMB(data = bro_dia, ldmc ~ treatment * climate, family = gaussian, na.action = na.fail)
dredge(bro_dia_ldmc) # best fit model is climate
bro_dia_ldmc <- glmmTMB(data = bro_dia, ldmc ~ climate, family = gaussian, na.action = na.fail)
...
shapiro.test(residuals(fes_myu_la)) # not quite normal
...
#### LDMC
```{r}
fes_myu_ldmc <- glmmTMB(data = fes_myu, ldmc ~ treatment * climate + (1|new_block), family = gaussian, na.action = na.fail) # get convergence error

fes_myu_ldmc <- glm(data = fes_myu, ldmc ~ treatment * climate, family = gaussian, na.action = na.fail)
dredge(fes_myu_ldmc) # best fit model is intercept only, but would need to average
fes_myu_ldmc <- glm(data = fes_myu, ldmc ~ 1, family = gaussian, na.action = na.fail)

simulateResiduals(fes_myu_ldmc, plot= T) # ok?
shapiro.test(residuals(fes_myu_ldmc)) # not normal

# log transformation
fes_myu_ldmc <- glmmTMB(data = fes_myu, log_ldmc ~ treatment * climate + (1|new_block), family = gaussian, na.action = na.fail) # get convergence error

fes_myu_ldmc <- glm(data = fes_myu, log_ldmc ~ treatment * climate, family = gaussian, na.action = na.fail)
dredge(fes_myu_ldmc) # best fit model is intercept only
fes_myu_ldmc <- glm(data = fes_myu, log_ldmc ~ 1, family = gaussian, na.action = na.fail)

simulateResiduals(fes_myu_ldmc, plot= T) # does not pass KS test
shapiro.test(residuals(fes_myu_ldmc)) # not normal
```
### Bromus hordeaceus
```{r}
...
* has huge outlier
```{r}
bro_tec_la <- glmmTMB(data = bro_tec, indiv_area ~ treatment * climate + (1|new_block), family = gaussian, na.action = na.fail) # convergence
bro_tec_la <- glmmTMB(data = bro_tec, indiv_area ~ treatment * climate, family = gaussian, na.action = na.fail)
dredge(bro_tec_la) # best fit is intercept
bro_tec_la <- glmmTMB(data = bro_tec, indiv_area ~ 1, family = gaussian, na.action = na.fail)

simulateResiduals(bro_tec_la, plot= T) # not good
shapiro.test(residuals(bro_tec_la)) # not normal
```
#### SLA
SLA ~ intercept + block
*need to do averaging
...
#### LA
```{r}
hor_mur_la <- glmmTMB(data = hor_mur, indiv_area ~ climate * treatment + (1|new_block), family = gaussian, na.action = na.fail) # convergence issue
hor_mur_la <- glm(data = hor_mur, indiv_area ~ climate * treatment, family = gaussian, na.action = na.fail)
dredge(hor_mur_la) # best fit intercept only
hor_mur_la <- glm(data = hor_mur, indiv_area ~ 1, family = gaussian, na.action = na.fail)

simulateResiduals(hor_mur_la, plot=T) # does not pass KS test
shapiro.test(residuals(hor_mur_la)) # not normal

# log transformation
hor_mur_la <- glmmTMB(data = hor_mur, log_la ~ climate * treatment + (1|new_block), family = gaussian, na.action = na.fail)
dredge(hor_mur_la) # best fit model is intercept
hor_mur_la <- glmmTMB(data = hor_mur, log_la ~ 1 + (1|new_block), family = gaussian, na.action = na.fail)

simulateResiduals(hor_mur_la, plot=T) # ok
shapiro.test(residuals(hor_mur_la)) # not normal
...
dredge(hor_mur_sla) # best fit model is intercept, but would need to do averaging
...
simulateResiduals(hor_mur_ldmc, plot= T) # does not pass KS test
shapiro.test(residuals(hor_mur_ldmc)) # normal

# log transformation
hor_mur_ldmc <- glmmTMB(data = hor_mur, log_ldmc ~ treatment * climate + (1|new_block), family = gaussian, na.action = na.fail)
dredge(hor_mur_ldmc) # best fit model is intercept
hor_mur_ldmc <- glmmTMB(data = hor_mur, log_ldmc ~ 1 + (1|new_block), family = gaussian, na.action = na.fail)
...
LA ~ climate
```{r}
ero_cic_la <- glmmTMB(data = ero_cic, indiv_area ~ climate * treatment + (1|new_block), family = gaussian, na.action = na.fail)
dredge(ero_cic_la) # convergence problem
ero_cic_la <- glmmTMB(data = ero_cic, indiv_area ~ climate * treatment, family = gaussian, na.action = na.fail)
dredge(ero_cic_la)  # best fit climate only
ero_cic_la <- glmmTMB(data = ero_cic, indiv_area ~ climate, family = gaussian, na.action = na.fail)
...
hor_mur_sla <- glmmTMB(data = ero_cic, sla ~ 1 + (1|new_block), family = gaussian, na.action = na.fail)
...
dredge(ero_cic_ldmc) # best fit model is climate, but need to do averaging
hor_mur_ldmc <- glmmTMB(data = ero_cic, ldmc ~ climate + (1|new_block), family = gaussian, na.action = na.fail)

simulateResiduals(ero_cic_ldmc, plot= T) # good
...
# does data fit model?
simulateResiduals(gal_apa_sla, plot=T) # ok?
shapiro.test(residuals(gal_apa_sla)) # normal
```
#### LDMC
log(LDMC) ~ climate + block
```{r}
gal_apa_ldmc <- glmmTMB(data = gal_apa, ldmc ~ climate * treatment + (1|new_block), family = gaussian, na.action = na.fail) # model convergence
gal_apa_ldmc <- glmmTMB(data = gal_apa, ldmc ~ climate * treatment, family = gaussian, na.action = na.fail)
dredge(gal_apa_ldmc ) # best fit climate only
gal_apa_ldmc <- glmmTMB(data = gal_apa, ldmc ~ climate, family = gaussian, na.action = na.fail)
...
dredge(pla_not_sla) # best fit climate only
