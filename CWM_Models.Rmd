...
emmeans(LA_CWM, specs = pairwise ~ treatment * climate)
la_emmeans_clim <- as.data.frame(summary(emmeans(LA_CWM, specs = pairwise ~ treatment))$contrasts) %>% 
  dplyr::select(contrast, estimate, p.value)

pretty_table <- la_emmeans_clim %>% 
  as_tibble() %>% 
  gt(rowname_col = "contrast") %>% 
  tab_header(
    title = "Comparisons by Treatment") %>% 
  fmt_number("p.value", decimal = 4) %>% 
  tab_style(
    style = cell_text(weight = "bold"),
    locations = cells_body(
...
gtsave(data = pretty_table, filename = "CWM_LA_by_treatment.png", path = "~/github/Tejon_Functional_Traits/Figures")
...
la_emmeans_clim <- as.data.frame(summary(emmeans(SLA_CWM, specs = pairwise ~ treatment))$contrasts) %>% 
  dplyr::select(contrast, estimate, p.value)
...
gtsave(data = pretty_table, filename = "CWM_SLA_by_treatment.png", path = "~/github/Tejon_Functional_Traits/Figures")

la_emmeans_clim <- as.data.frame(summary(emmeans(SLA_CWM, specs = pairwise ~ climate))$contrasts) %>% 
  dplyr::select(contrast, estimate, p.value)
...
gtsave(data = pretty_table, filename = "CWM_SLA_by_climate.png", path = "~/github/Tejon_Functional_Traits/Figures")
```
#### c. LDMC CWM
...
la_emmeans_clim <- as.data.frame(summary(emmeans(LDMC_CWM, specs = pairwise ~ treatment))$contrasts) %>% 
  dplyr::select(contrast, estimate, p.value)
...
gtsave(data = pretty_table, filename = "CWM_LDMC_by_treatment.png", path = "~/github/Tejon_Functional_Traits/Figures")

la_emmeans_clim <- as.data.frame(summary(emmeans(LDMC_CWM, specs = pairwise ~ climate))$contrasts) %>% 
  dplyr::select(contrast, estimate, p.value)
...
gtsave(data = pretty_table, filename = "CWM_LDMC_by_climate.png", path = "~/github/Tejon_Functional_Traits/Figures")
...
la_emmeans_clim <- as.data.frame(summary(emmeans(log_seed_mass, specs = pairwise ~ treatment))$contrasts) %>% 
  dplyr::select(contrast, estimate, p.value)
...
gtsave(data = pretty_table, filename = "CWM_seed_by_treatment.png", path = "~/github/Tejon_Functional_Traits/Figures")

la_emmeans_clim <- as.data.frame(summary(emmeans(log_seed_mass, specs = pairwise ~ climate))$contrasts) %>% 
  dplyr::select(contrast, estimate, p.value)
...
gtsave(data = pretty_table, filename = "CWM_seed_by_climate.png", path = "~/github/Tejon_Functional_Traits/Figures")
...
la_emmeans_clim <- as.data.frame(summary(emmeans(log_n_CWM, specs = pairwise ~ treatment))$contrasts) %>% 
  dplyr::select(contrast, estimate, p.value)
...
gtsave(data = pretty_table, filename = "CWM_LNC_by_treatment.png", path = "~/github/Tejon_Functional_Traits/Figures")

la_emmeans_clim <- as.data.frame(summary(emmeans(log_n_CWM, specs = pairwise ~ climate))$contrasts) %>% 
  dplyr::select(contrast, estimate, p.value)
...
gtsave(data = pretty_table, filename = "CWM_LNC_by_climate.png", path = "~/github/Tejon_Functional_Traits/Figures")
...
LA_CWM_plot <- plot(ggpredict(LA_CWM, terms = c("treatment", "climate")), facet = TRUE)
SLA_CWM_plot <- plot(ggpredict(SLA_CWM, terms = c("treatment", "climate")), facet = TRUE)
LDMC_CWM_plot <- plot(ggpredict(LDMC_CWM, terms = c("treatment", "climate")), facet = TRUE)
log_seed_mass_plot <- plot(ggpredict(log_seed_mass, terms = c("treatment", "climate")), facet = TRUE)
log_n_CWM_plot <- plot(ggpredict(log_n_CWM, terms = c("treatment", "climate")), facet = TRUE)
